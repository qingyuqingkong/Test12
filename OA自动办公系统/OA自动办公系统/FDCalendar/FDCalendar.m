...
- (UIView *)datePickerView {
    if (!_datePickerView) {
        ...
        [cancelButton setTitleColor:[UIColor colorWithRed:109/255.0 green:49/255.0 blue:23/255.0 alpha:1.0] forState:UIControlStateNormal];
        ...
        [okButton setTitleColor:[UIColor colorWithRed:109/255.0 green:49/255.0 blue:23/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (void)setupTitleBar {
    ...
    titleView.backgroundColor = [UIColor colorWithRed:109/255.0 green:49/255.0 blue:23/255.0 alpha:0.4];
...
- (void)setupWeekHeader {
    ...
    for (int i = 0; i < count; i++) {
        ...
        if (i == 0 || i == count - 1) {
            weekdayLabel.textColor = [UIColor colorWithRed:109/255.0 green:49/255.0 blue:23/255.0 alpha:1.0];
        } else {
...
- (void)calendarItem:(FDCalendarItem *)item didSelectedDate:(NSDate *)date {
    ...
    NSString *choiceDate = [formatter stringFromDate:date];
    
    //创建一个消息对象
    NSNotification *notif = [NSNotification notificationWithName:@"choice_date" object:nil userInfo:@{@"choiceDate":choiceDate}];
    NSNotificationCenter *center = [NSNotificationCenter defaultCenter];
    [center postNotification:notif];
    //[center postNotificationName:@"choice_date" object:self userInfo:@{@"choicedDate":choiceDate}];
